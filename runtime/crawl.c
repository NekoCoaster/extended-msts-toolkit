...
#define G(a) (a)
#endif
enum {FRAME,EXIT,WHEEL,ROD,SPLIT,BODY,FORCE,DRAG,MANUAL_KEY,HOOK_COUNT};
#include "prologues.h"
...
typedef struct {U originalReturn,slot,bits,a,b,links[4];} Call;
...
static U wakes,drag_calls,wheel_calls,rod_calls,impulses,graph_changes;
...
static void enter_effect(U id,Registers *r){
 U *s=(U*)(r+1),body=0,offset=0,i;Call *call;Car *c;double speed,rate;float factor,omega[3],forward[3];

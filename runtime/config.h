...
static int crawl_hud_left,cab_needles,background_audio,ignore_red_signal,restore_movie_focus,system_movie_decoder,separate_movie_window,bind_movie_output;
...
static void read_config(void){
 ...
 system_movie_decoder=read_bool(path,L"Startup",L"UseSystemMovieDecoder");
 bind_movie_output=read_bool(path,L"Startup",L"BindMovieOutput");
 separate_movie_window=read_bool(path,L"Startup",L"SeparateMovieWindow");

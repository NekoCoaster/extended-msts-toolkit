...
int main(void){int x,y;char launch[256];
 ...
 normalize_launch("train.exe -toolset",launch,1,1);assert(!strcmp(launch,"train.exe -toolset"));
 normalize_launch("train.exe -toolset -vm:w,1280,720,32",launch,1,1);assert(!strcmp(launch,"train.exe -toolset -vm:w,1280,720,32"));
 normalize_launch("train.exe",launch,1,1);assert(!strcmp(launch,"train.exe -vm:w -noclamp"));
 normalize_launch("train.exe -vm:w,1280,720,32",launch,1,1);assert(!strcmp(launch,"train.exe -vm:w,1280,720,32 -noclamp"));
 normalize_launch("train.exe \"-NOCLAMP\"",launch,1,1);assert(!strcmp(launch,"train.exe \"-NOCLAMP\" -vm:w"));
 normalize_launch("train.exe -vm:1920,1080,32",launch,0,1);assert(!strcmp(launch,"train.exe -vm:1920,1080,32"));
 assert(!has_noclamp("train.exe -noclampX")&&!has_noclamp("\"C:\\-noclamp\\train.exe\""));
 normalize_launch("train.exe",launch,0,0);assert(!strcmp(launch,"train.exe"));
 normalize_launch("train.exe",launch,1,0);assert(!strcmp(launch,"train.exe -noclamp"));
 normalize_launch("train.exe -vm:w",launch,0,0);assert(!strcmp(launch,"train.exe -vm:w"));
 normalize_launch("train.exe \"-VM:W,1280,720,32\"",launch,0,0);assert(!strcmp(launch,"train.exe \"-VM:W,1280,720,32\""));
 normalize_launch("train.exe -vm:1920,1080,32",launch,0,0);assert(!strcmp(launch,"train.exe -vm:1920,1080,32"));
 normalize_launch("train.exe -toolset",launch,1,0);assert(!strcmp(launch,"train.exe -toolset"));

...
import java.io.*;
public class TelemetryServiceWrites extends GhidraScript {
 public void run() throws Exception {
  try(PrintWriter out=new PrintWriter(new File(getScriptArgs()[0],"service-offset-writes.tsv"))){
   ...
   while(it.hasNext()&&!monitor.isCancelled()){
    ...
    boolean hit=false;
    for(Object o:ins.getOpObjects(0))if(o instanceof Scalar){long v=((Scalar)o).getSignedValue();if(v==0x204||v==0x30)hit=true;}

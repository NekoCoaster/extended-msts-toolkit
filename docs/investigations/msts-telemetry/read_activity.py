...
def capture(r):
    ...
    while n!=root:
        ...
        row['state_20']=r.unpack(e+0x20,'i')[0]
        row['activation_level']=r.unpack(e+0x24,'i')[0]
        row['activation_positive']=row['activation_level']>0
        if row['category']==2:
    ...
    return dict(activity_base=0x809810,event_sentinel=root,events=events,event_evaluation_stop=r.u(0x809810+0x348),event_outcome_success=r.u(0x809810+0x34c))

...
## Combined motion capture checkpoint (latest local)

Published66cb09b/PR9 contains902candidates through pass162. New local capture_motion_context.py and analyse_motion_context.py preserve748grain samples,0errors,moving start and early emergency braking,with body/definition/track/timing inputs.2162eligible moving player pairs reproduce stored-velocity discrepancy:body and track movement median excess approximately5.35m/s,body-minus-track median0.000858m/s,origin tile unchanged. Cause and dynamic endpoint validation remain open.

Exited Maryland without saving,reloaded preferred grain through UI. GamePID7160 now paused73885.8046875,player40000723cars speed0,AI40000522cars native speed15.41961956,both0derailed flags. Rediscover addresses after reload. No game-memory writes,asset edits or save overwrite. All jobs terminal. Next bounded combined AI capture while player stays braked;analyse complete endpoint trajectories and trace player track-distance producer. Station tests and full broader goal remain open. Inventory902,412evidence paths,126unchanged assets;new combined-motion findings local after66cb09b.

## Moving AI and connection derivative checkpoint (latest local)

Inventory902,418evidence paths,126original assets unchanged;local audit passes. New combined AI capture649samples0errors records22-car AI passing stationary23-car player. Endpoint derivative analysis now covers2021player and1736AI moving connection comparisons. Stored-state projection and observed gap differences retain discrepancies,including same-clock samples. Worst AI sample contains zero body velocity despite nonzero car/train speed;consistent with intermediate reset/refresh phase,not proof of actual stopping or exact writer execution. See MOTION-DIFFERENCE-FINDINGS.md and both connection summaries.

GamePID7160 last verified paused73969.7109375,player speed0,AI stored speed16.209196m/s,all0derailed. No game-memory writes,asset edits or save overwrite. All capture/analysis jobs terminal. Independent research only,no prioritization or NEMT integration. Next investigate producer phases and player track-distance integration;station/infrastructure/lifecycle and broader discovery remain open. Prepared for branch research/issue-7-msts-telemetry and draftPR9,after66cb09b.

## Independent physics time checkpoint (latest local)

Inventory909=311direct23derived68cab507config,424evidence paths,126original asset hashes unchanged;local audit passes. INTEGRATOR-TIME-FINDINGS.md establishes seven shared integrator candidates. Paused11sample/0error capture has gameplay elapsed169.710281s versus physics accumulator270.662750s,mode1,current/configured step0.010000001s,45registered bodies. This identifies distinct stored time bases;moving cadence and causal explanation remain unproven. capture_motion_context.py now records both integrator endpoints with pointer/vtable guards;prior immutable captures preserved.

Pass163/164/165 exported setter/getter/loop and virtual pre/post callbacks plus mode1 first-order solver;all5229+125+959instruction bytes match disk/live. Outer loop has no visible remainder clamp;callback/solver and runtime timing require further discrimination before any correction. No UI input or game writes this turn;PID7160 remains paused73969.7109375,all jobs terminal. Next capture moving player with integrator time alongside body/track clocks;check integrator delta versus gameplay delta and trajectory increments. Last publishedPR9=7ead7fd/902;new909checkpoint local. Full research goal remains active,with station,infrastructure,lifecycle and broader unresolved coverage unchanged.

## Moving dual-clock validation checkpoint (latest local)

909candidates,428evidence paths,126original asset hashes unchanged;local audit passes. integrator-moving-grain-01:1296samples0errors,130wall seconds,98initialpaused,mode1 throughout. Player1802eligible car pairs:body discrepancy median5.179556m/s using gameplay time versus0.002479 using physics time;track5.157436 versus0.008972. AI1790pairs instead worsen from0.664115 to8.205889 body discrepancy using physics time. Same-clock subsets retain the contrast. Results strongly support separate time bases for player physics and AI movement in this configuration;no universal conversion,exact equivalence,or complete root-cause attribution claimed.

Normal UI exited/reloaded Grain Train Through the Night without saving;closedbriefing and applied early Backspace brake. GamePID7160 now paused73934.734375,elapsed134.731185913,physics217.280517578,player23cars0speed,AI22cars21.130149841storedspeed,all0derailed. Unsampledtail after series completion retained as gap;no memory writes/settings changes/assets edits. All jobs terminal. New analyzer preserves raw source hash and matched pair comparisons. Next connection derivative reanalysis under respective time bases and frame-step attribution;broader goal remains active. Last publishedPR9=7ead7fd/902;local909clock research pending publication.

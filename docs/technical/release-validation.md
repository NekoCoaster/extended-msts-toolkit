# Historical toolkit migration validation — 2026-09-12

These live observations describe the migration DLL hash below, not the later borderless build. Subsequent host testing succeeded; checkpoint: `nemt-migration-host-tested` (`dd8da28`).
